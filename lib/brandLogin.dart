...
class BrandLogin extends StatefulWidget {
  const BrandLogin({Key? key}) : super(key: key);
  @override
  _BrandLoginState createState() => _BrandLoginState();
}

class _BrandLoginState extends State<BrandLogin> {
                            ...
                            if (_email.text.isEmpty || _email.text == '') {
                              ...
                              await FirebaseAuth.instance
                                ...
                                if (aaa == '' || aaa.isEmpty) {
                                  final SnackBar snackbar = SnackBar(
                                    content:
                                        Text("Your brand is not registered"),
                                    duration: Duration(seconds: 5),
                                    backgroundColor: Colors.red,
                                    action: SnackBarAction(
                                      label: 'Close',
                                  ...
                                  Navigator.push(
                                    this.context,
                                    MaterialPageRoute(
                                        builder: (context) => BrandDashboard()),
                                  );
                                }
                                _pass.clear();
                                _email.clear();
